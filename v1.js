...
var businesscommunications_v1;
(function (businesscommunications_v1) {
    /**
    ...
    class Resource$Brands {
        constructor(context) {
            this.context = context;
            this.agents = new Resource$Brands$Agents(this.context);
            this.locations = new Resource$Brands$Locations(this.context);
        }
    ...
    businesscommunications_v1.Resource$Brands = Resource$Brands;
    class Resource$Brands$Agents {
        ...
        requestLaunch(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:requestLaunch').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['name'],
        ...
        requestVerification(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:requestVerification').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['name'],
    ...
    class Resource$Brands$Agents$Greetings {
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/greetings').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                }, options),
                params,
                requiredParams: ['parent'],
    ...
    businesscommunications_v1.Resource$Brands$Agents$Greetings = Resource$Brands$Agents$Greetings;
